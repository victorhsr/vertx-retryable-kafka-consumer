 ...
 **/
@Component
public class RecommendationsRouterProvider extends AbstractRouterProvider {

    private static final String ROOT_PATH = "/recommendations";

    private final RouterDefinition routerDefinition;

    protected RecommendationsRouterProvider(RequestFailureHandler requestFailureHandler, RequestHandlerProxy requestHandlerProxy, Vertx vertx) {
